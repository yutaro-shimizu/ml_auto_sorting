...
def generate_tree_structure(summaries, api_url="http://localhost:11434/api/generate"):
    ...
    Returns:
        list: A list of dictionaries with src_path, summary, and dst_path.
    """
...
- Format file names: Avoid spaces, capital letters or special characters in your file names. Use underscores instead.
...
Your response must ONLY be a JSON array of objects with the following schema:
[
    {
